...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ak1ymma.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ak1ymma.containers.anotherwebservice.com/
...
```
git clone git@github.com:lyricndigit/container-ak1ymma.git
cd container-ak1ymma
```
...
```
docker attach container-ak1ymma
```
